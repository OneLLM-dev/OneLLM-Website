document.addEventListener('DOMContentLoaded', () => {
  ...
  costSections.appendChild(createCostSection('Affordable Models', pricingData.affordable));
  costSections.appendChild(createCostSection('Intermediate Models', pricingData.intermediate));
  costSections.appendChild(createCostSection('Advanced Models', pricingData.advanced));
